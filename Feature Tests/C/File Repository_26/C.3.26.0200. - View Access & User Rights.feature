Feature: User Interface: The system shall support limiting file repository user view access and export rights.
    ...
    Scenario: C.3.26.200.100 Limit user view and export access based on User Rights and DAG
        ...
        And I select "TestGroup1" in the dropdown field labeled "Limit access by Data Access Group?"
        ...
        And I select "1_FullRights" in the dropdown field labeled "Limit access by User Role?"
        And I click on the button labeled "Create folder" in the dialog box
        ...
        Then I should see '"test_user1" has been successfully ASSIGNED to the user role "1_FullRights".'
        ...
        And I click on the button labeled "Assign to role" on the tooltip
        And I select "3_ReadOnly_Deidentified" on the dropdown field labeled "Select Role" 
        And I click on the button labeled exactly "Assign"
        Then I should see 'User "test_user3" has been successfully ASSIGNED to the user role "3_ReadOnly_Deidentified".'

        When I click on the link labeled "test_user4"
        And I click on the button labeled "Assign to role" on the tooltip
        And I select "3_ReadOnly_Deidentified" on the dropdown field labeled "Select Role"
        And I click on the button labeled exactly "Assign"
        Then I should see 'User "test_user4" has been successfully ASSIGNED to the user role "3_ReadOnly_Deidentified".'
