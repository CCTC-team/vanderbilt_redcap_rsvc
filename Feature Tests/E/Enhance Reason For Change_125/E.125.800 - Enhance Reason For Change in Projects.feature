Feature: The system shall allow the configuration of project-level default dropdown options for 'Reason for Change' through the Enhance Reason for Change module
  ...
  Scenario: Enable external module in project
    Given I create a new project named "E.125.800" by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "redcap_val/E125800.xml", and clicking the "Create Project" button
