Feature: E.126.100 - The system shall support the ability to enable/disable Enhance form status external module.
  ...
  Scenario: E.126.200 - Enable module on all projects by default
    Given I login to REDCap with the user "Test_Admin"
    When I click on the link labeled "Control Center"
  ...
  Scenario: E.126.300 - Make module discoverable by users
    Given I login to REDCap with the user "Test_Admin"   
    When I click on the link labeled "Control Center"
    And I click on the link labeled exactly "Manage"
    Then I should see "External Modules - Module Manager"
  ...
  Scenario: E.126.400 - Allow non-admins to enable this module on projects
    Given I login to REDCap with the user "Test_Admin"
    When I click on the link labeled "Control Center"   
    And I click on the link labeled exactly "Manage"
    Then I should see "External Modules - Module Manager"
  ...
  Scenario: E.126.500 - Hide this module from non-admins in the list of enabled modules on each project
  ...
  Scenario: E.126.600 - View Usage of the external module
    When I click on the link labeled "Control Center"
    And I click on the link labeled exactly "Manage"
    Then I should see "Enhance form status - v0.0.0"
    When I click on the button labeled "View Usage"
    Then I should see a link labeled "E.126.100.400" in the dialog box
    And I should see a link labeled "E.126.100.500" in the dialog box
    And I should see a link labeled "E.126.100.600" in the dialog box
    When I click on the link labeled "E.126.100.400" in the dialog box
    # # For Request Activation of project E.126.100.300 which doesn't work in ATS.
    # # Can be checked manually
    # And I should see a link labeled "E.126.100.300" in the dialog box
    Then I should see "Project Home"
    And I should see "E.126.100.400"
  
  Scenario: E.126.100 - Disable external module
    # Disable external module in project E.126.100.400
    Given I click on the link labeled exactly "Manage"
    Then I should see "External Modules - Project Module Manager"
    And I should see "Enhance form status - v0.0.0"
