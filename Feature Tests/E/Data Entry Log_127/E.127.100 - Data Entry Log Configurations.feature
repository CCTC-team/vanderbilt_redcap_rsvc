Feature: E.127.100 - The system shall support the ability to enable/disable Data Entry Log external module.
  ...
  Scenario: E.127.300 - Make module discoverable by users
    Given I login to REDCap with the user "Test_Admin"
    When I click on the link labeled "Control Center"
    And I click on the link labeled exactly "Manage"
    Then I should see "External Modules - Module Manager"
  ...
  Scenario: E.127.500 - Hide this module from non-admins in the list of enabled modules on each project
  ...
  Scenario: E.127.600 - View Usage of the external module
    When I click on the link labeled "Control Center"
    And I click on the link labeled exactly "Manage"
    Then I should see "Data Entry Log - v0.0.0"
    When I click on the button labeled "View Usage"
    Then I should see a link labeled "E.127.100.400" in the dialog box
    And I should see a link labeled "E.127.100.500" in the dialog box
    And I should see a link labeled "E.127.100.600" in the dialog box
    When I click on the link labeled "E.127.100.400" in the dialog box
    # # For Request Activation of project E.127.100.300 which doesn't work in ATS.
    # # Can be checked manually
    # And I should see a link labeled "E.127.100.300" in the dialog box
    Then I should see "Project Home"
    And I should see "E.127.100.400"
    And I logout
