Feature: E.127.2500 - RepeatingInstruments_SingleArm_noDAGs
  ...
  Scenario: Enable external module in project
    Given I create a new project named "E.127.2500" by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "redcap_val/ProjectTypes/RepeatingInstruments_SingleArm_noDAGs.xml", and clicking the "Create Project" button
  ...
  Scenario: E.127.1200, E.127.1300 - Data Entry Log for Repeating Instruments in Arm 1
    ...
    And I click on the link labeled "E.127.2500"
