Feature: E.128.1900 - RepeatingEvents_DoubleArm_withDAGs
  ...
  Scenario: Enable external module in project
    Given I create a new project named "E.128.1900" by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "redcap_val/ProjectTypes/RepeatingEvents_DoubleArm_withDAGs.xml", and clicking the "Create Project" button
    ...
    And I select "accepted: can't resolve" in the dropdown field in column "Response" for the field "notesbox"
    And I enter "Response1" in the column "Response" for the field "notesbox"
    And I select "rejected: query is in error" in the dropdown field in column "Response" for the field "checkbox"
