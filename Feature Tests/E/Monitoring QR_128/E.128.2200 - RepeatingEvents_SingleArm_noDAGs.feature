Feature: E.128.2200 - RepeatingEvents_SingleArm_noDAGs
  ...
  Scenario: Enable external module in project
    Given I create a new project named "E.128.2200" by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "redcap_val/ProjectTypes/RepeatingEvents_SingleArm_noDAGs.xml", and clicking the "Create Project" button
